                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-title" data-toggle="collapse" data-target="#collapseOne1">
                                            MPR Shortlisted Score Cv Filters
                                        </div>
                                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered"
                                            ...
                                            <tr>
                                                ...
                                                <td class=" dt-center">  <img src="https://www.countryflags.io/EG/shiny/32.png" title="Egypt"></td>
                                                <td class=" dt-center">Riyadh</td>
                                                <td class=" dt-center">2020-09-22 05:02:23</td>
                                                <td class=" dt-center">
                                                    <a target="_blank" href="#"><i class="icon-xl far fa-file-pdf text-warning" aria-hidden="true"></i></a>
                                                </td>
                                                <td class=" dt-center">
                                                    <span class="label label-outline-success text-dark">30</span>
                                                </td>
                                                <td class=" dt-center">
                                            ...
                                            <tr>
                                                ...
                                                <td class=" dt-center">
                                                    <span class="label label-outline-warning text-dark">25</span>
                                                </td>
                                                <td class=" dt-center">
                                            ...
                                            <tr>
                                                ...
                                                <td class=" dt-center">
                                                    <span class="label label-outline-yellow text-dark">25</span>
                                                </td>
                                                <td class=" dt-center">

                                                    <a href="#" target="_blank" class="btn btn-icon btn-outline-success btn-sm">
                                                        <i class="fas fa-chart-bar"></i>
                                                    </a>
                                            ...
                                            <tr>
                                                ...
                                                <td class=" dt-center">
                                                    <span class="label label-outline-blue text-dark">14</span>
                                                </td>
                                                <td class=" dt-center">
                                            ...
                                            <tr>
                                                ...
                                                <td class=" dt-center">
                                                    <span class="label label-outline-gray text-dark">9</span>
                                                </td>
                                                <td class=" dt-center">
                                            ...
                                            <tr>
                                                ...
                                                <td class=" dt-center">
                                                    <span class="label label-outline-danger text-dark">9</span>
                                                </td>
                                                <td class=" dt-center">
