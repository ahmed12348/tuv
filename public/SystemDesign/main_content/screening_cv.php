    ...
    <div class="subheader py-2 py-lg-12  subheader-transparent " id="kt_subheader">
        <div class=" container  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center">
                ...
                <!--begin::Button-->
                <a href="?page=add_cv" class="btn btn-white font-weight-bold py-3 px-6">
                    Add New CV
                </a>
                <!--end::Button-->
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="kt_datatable2">
                                            ...
                                            <tr>
                                                ...
                                                <th rowspan="2">Evaluation CV By</th>
                                                ...
                                                <th rowspan="2">CV Evaluation</th>
                                                <th rowspan="2">Edit / Delete</th>
                                                <th rowspan="2">Send to company approval</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <button type="button" class="btn btn-primary dropdown-toggle btn-sm" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Evaluation</button>
