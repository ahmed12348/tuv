jQuery(function ($) {
 ...
 /*   $(".header-carousel").hover(function () {
    ...
    var instructorCarousel = new Swiper('.instructor-carousel', {
        ...
        pagination: {el: '.instructor-pagination', clickable: true},
    });
    ...
    var eventSpeakerCarousel = new Swiper('.event-speaker-carousel', {
        ...
        spaceBetween: 30,
        speed: 1500,
        breakpoints: {0: {slidesPerView: 2,}, 768: {slidesPerView: 3,}, 1200: {slidesPerView: 4,}},
        navigation: {nextEl: '.swiper-button-next', prevEl: '.swiper-button-prev',}
    });
    ...
    //     newCounter2();
    // }, 1000)
    var $grid = $(".gallery-tab-details").isotope({itemSelector: '.element-item', layoutMode: 'fitRows',});
