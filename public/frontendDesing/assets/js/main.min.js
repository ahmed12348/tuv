...
var FullCalendar = function (e) {
    ...
    var Fn = function () {
        ...
        return e.prototype.setProp = function (e, t) {
            ...
            if (n) {
                var r = this._def, o = this._context, i = Ot(o.getCurrentData().eventStore, n.instanceId);
                i = Hn(i, {
                    "": {
                        display: "",
                        startEditable: !0,
    ...
    var Or = FullCalendarVDom.Component, Ar = FullCalendarVDom.createElement, Ur = FullCalendarVDom.render,
        ...
        zr = FullCalendarVDom.flushToDom, Fr = FullCalendarVDom.unmountComponentAtNode, Br = function () {
            function e(e, t, n) {
                var o = this;
    ...
    var qr = function (e) {
        ...
        return n(t, e), t.prototype.shouldComponentUpdate = function (e, t) {
            return this.debug && console.log(ze(e, this.props), ze(t, this.state)), !Fe(this.props, e, this.propEquality) || !Fe(this.state, t, this.stateEquality)
    ...
    var so = function (e) {
        ...
        return n(t, e), t.prototype.prepareHits = function () {
            ...
            return !this.props.eventDrag && !this.props.eventResize && !F(e, ".fc-event-mirror") && (this.isPopover() || !this.isInPopover(e))
        }, t.prototype.isValidDateDownEl = function (e) {
            return !(F(e, ".fc-event:not(.fc-bg-event)") || F(e, ".fc-daygrid-more-link") || F(e, "a[data-navlink]") || this.isInPopover(e))
    ...
    function Vo(e, t, n, r, o) {
        var i = [];
        return {
            headerToolbar: e.headerToolbar ? zo(e.headerToolbar, e, t, n, r, o, i) : null,
            footerToolbar: e.footerToolbar ? zo(e.footerToolbar, e, t, n, r, o, i) : null,
            viewsWithButtons: i
        }
    }
    ...
    var Go = [lo({
        ...
        eventSourceRefiners: {
            ...
            parseMeta: function (e) {
                ...
                Fo(o.method, o.url, i, (function (e, n) {
                    t({rawEvents: e, xhr: n})
                }), (function (e, t) {
                    n({message: e, xhr: t})
                }))
    ...
    var Jo = function () {
        function e(e) {
            ...
            var s, l, u,
                c = (s = o.calendarOptions, l = o.dateEnv, null != (u = s.initialDate) ? l.createMarker(u) : zn(s.now, l)),
        ...
        return e.prototype.resetOptions = function (e, t) {
            ...
            for (var p = Mo(n.eventSources, e, d, u), f = xo(p), h = Jr(n.eventStore, e, p, d, u), v = f && !l.options.progressiveEventRendering && n.renderableEventStore || h, g = this.buildViewUiProps(u), m = g.eventUiSingleBase, y = g.selectionConfig, E = this.buildEventUiBySource(p), S = this.buildEventUiBases(v.defs, m, E), D = n.loadingLevel || 0, b = f, C = {
    ...
    }(), hi = {}, vi = {startTime: Xe, duration: Xe, create: Boolean, sourceId: String};

    function gi(e) {
        var t = It(e, vi), n = t.refined, r = t.extra;
        return {
    ...
    var mi = function (e) {
        ...
        function t(t) {
            ...
            return n.handleSegClick = function (e, t) {
                ...
                if (i && r.isValidSegDownEl(e.target)) {
                    var a = F(e.target, ".fc-event-forced-url"), s = a ? a.querySelector("a[href]").href : "";
        ...
        function t() {
            ...
            return t.buildViewContext = st(Gr), t.buildViewPropTransformers = st(wi), t.buildToolbarProps = st(Ci), t.handleNavLinkClick = X("a[data-navlink]", t._handleNavLinkClick.bind(t)), t.headerRef = Lr(), t.footerRef = Lr(), t.interactionsStore = {}, t.registerInteractiveComponent = function (e, n) {
                var r = ci(e, n), o = [Si, Di].concat(t.props.pluginHooks.componentInteractions).map((function (e) {
                    return new e(r)
                }));
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return Ar(jr.Provider, {value: l}, n.headerToolbar && Ar(yi, r({
                ref: this.headerRef,
            ...
            }, this.renderView(t), this.buildAppendContent()), n.footerToolbar && Ar(yi, r({
                ref: this.footerRef,
    ...
    var xi = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.context, t = e.dateEnv, n = e.options, o = e.theme, i = e.viewApi, a = this.props, s = a.date,
                l = a.dateProfile, u = gr(s, a.todayRange, null, l), c = [ki].concat(mr(u, o)),
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.context, n = t.dateEnv, o = t.theme, i = t.viewApi, a = t.options,
                ...
                u = [ki].concat(mr(l, o), e.extraClassNames || []), c = n.format(s, e.dayHeaderFormat),
    ...
    var Ni = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return Ar(Ii, {unit: "day"}, (function (e, t) {
                return Ar("tr", null, i && i(), n.map((function (e) {
                    return o ? Ar(xi, {
                        key: e.toISOString(),
                        date: e,
                        dateProfile: r,
                        ...
                        colCnt: n.length,
                        dayHeaderFormat: a
                    }) : Ar(_i, {key: e.getUTCDay(), dow: e.getUTCDay(), dayHeaderFormat: a})
                })))
            }))
        }, t
    }(Yr);
    ...
    var Oi = function () {
        ...
        return e.prototype.sliceProps = function (e, t, n, r) {
            ...
            for (var i = [], a = 4; a < arguments.length; a++) i[a - 4] = arguments[a];
            return e ? this._sliceEventStore.apply(this, o([Ge(e, Li(t, Boolean(n)), r), {}, t, n], i)).bg : []
    ...
    var Wi = /^(visible|hidden)$/, Vi = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return Wi.test(this.props.overflowX) ? 0 : this.el.offsetHeight - this.el.clientHeight
        }, t.prototype.getYScrollbarWidth = function () {
            return Wi.test(this.props.overflowY) ? 0 : this.el.offsetWidth - this.el.clientWidth
        }, t
    }(Yr), zi = function () {
        function e(e) {
            var t = this;
    ...
    var ta = function (e) {
        function t() {
            ...
            return t.processCols = st((function (e) {
                return e
            }), qi), t.renderMicroColGroup = st(Yi), t.scrollerRefs = new zi, t.scrollerElRefs = new zi(t._handleScrollerEl.bind(t)), t.state = {
                shrinkWidth: null,
                forceYScrollbars: !1,
        ...
        return n(t, e), t.prototype.render = function () {
            for (var e, t = this.props, n = this.state, r = this.context, i = t.sections || [], a = this.processCols(t.cols), s = this.renderMicroColGroup(a, n.shrinkWidth), l = Ki(t.liquid, r), u = i.length, c = 0, d = [], p = [], f = []; c < u && "header" === (e = i[c]).type;) d.push(this.renderSection(e, c, s)), c += 1;
            ...
            var o = this.props, i = this.state, a = i.forceYScrollbars, s = i.scrollerClientWidths,
                l = i.scrollerClientHeights, u = ji(o, e), c = Bi(o, e),
                d = o.liquid ? a ? "scroll" : u ? "auto" : "hidden" : "visible", p = Gi(e, r, {
                    tableColGroupNode: n,
                    tableMinWidth: "",
            ...
            return Ar("td", {ref: r.elRef}, Ar("div", {className: "fc-scroller-harness" + (c ? " fc-scroller-harness-liquid" : "")}, Ar(Vi, {
            ...
            return Xi(this.props.cols) ? Fi(this.scrollerElRefs.getAll()) : 0
    ...
    }, aa = bt({day: "numeric"}), sa = function (e) {
        function t() {
            return null !== e && e.apply(this, arguments) || this
        }

        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.context, n = t.options, r = la({
                date: e.date,
                dateProfile: e.dateProfile,
    ...
    function la(e) {
        ...
        return r(r(r({
            date: n.toDate(t),
            view: e.viewApi
        }, o), {dayNumberText: e.showDayNumber ? n.format(t, aa) : ""}), e.extraProps)
    }

    var ua = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.refineHookProps = lt(la), t.normalizeClassNames = yo(), t
        }
        ...
        function t(t, n) {
            ...
            return o.isRendering = !1, o.isRendered = !1, o.currentClassNames = [], o.customContentRenderId = 0, o.handleAction = function (e) {
                ...
                if (o.isRendering) {
                    o.isRendered = !0;
                    var e = o.currentData;
                    Ur(Ar(Ri, {options: e.calendarOptions, theme: e.theme, emitter: e.emitter}, (function (t, n, i, a) {
                        return o.setClassNames(t), o.setHeight(n), Ar(ho.Provider, {value: o.customContentRenderId}, Ar(bi, r({
                            isHeightAuto: i,
                            forPrint: a
                        }, e)))
                    })), o.el)
    ...
    var ga = 0, ma = 0, ya = !1, Ea = function () {
        function e(e) {
            var t = this;
        ...
        return e.prototype.destroy = function () {
            this.containerEl.removeEventListener("mousedown", this.handleMouseDown), this.containerEl.removeEventListener("touchstart", this.handleTouchStart, {passive: !0}), (ma -= 1) || window.removeEventListener("touchmove", Sa, {passive: !1})
            ...
            ya = !1, this.isDragging = !1, this.subjectEl = null, this.destroyScrollWatch()
    ...
    }(ba), Ra = "function" == typeof performance ? performance.now : Date.now, Ta = function () {
        function e() {
            var e = this;
    ...
    var xa = function () {
        ...
        return e.prototype.processFirstCoord = function (e) {
            ...
            !t && _a(this.movingHit, n) || (this.movingHit = n, this.emitter.trigger("hitupdate", n, !1, e))
    ...
    var Pa = function (e) {
        function t(t) {
            ...
            n.handlePointerDown = function (e) {
                ...
                if (!n.dragging.pointer.wasTouchScroll) {
                    ...
                    if (i && a && _a(i, a)) {
                        var s = t.context, l = r(r({}, Ia(i.dateSpan, s)), {
                            dayEl: i.dayEl,
                            jsEvent: e.origEvent,
        ...
        function t(t) {
            ...
            var o = t.component.context.options, i = n.dragging = new ka(t.el);
    ...
    var Ha = function (e) {
        function t(n) {
                ...
                if (o.isDragging) {
                    ...
                    if (o.clearDrag(), t.emitter.trigger("eventDragStop", {
                        ...
                        if (a === t) {
                            ...
                            }), a.emitter.trigger("drop", r(r({}, Ia(f.dateSpan, a)), {
                                draggedEl: e.subjectEl,
                                jsEvent: e.origEvent,
            ...
            var i = o.component.context.options, a = o.dragging = new ka(n.el);
        ...
        function t(t) {
            ...
            n.draggingSegEl = null, n.draggingSeg = null, n.eventRange = null, n.relevantEvents = null, n.validMutation = null, n.mutatedRelevantEvents = null, n.handlePointerDown = function (e) {
                ...
                e && (u = function (e, t, n, o, i) {
                    ...
                    state: p
                }) : i.dispatch({type: "UNSET_EVENT_RESIZE"}), d ? te() : ne(), t || (u && _a(s, e) && (u = null), n.validMutation = u, n.mutatedRelevantEvents = c)
            }, n.handleDragEnd = function (e) {
            ...
            var o = t.component, i = n.dragging = new ka(t.el);
    ...
    var Aa = function () {
        ...
        function e(e, t) {
            ...
            this.receivingContext = null, this.droppableEvent = null, this.suppliedDragMeta = null, this.dragMeta = null, this.handleDragStart = function (e) {
                ...
                if (n.clearDrag(), o && i) {
                    ...
                    if (o.emitter.trigger("drop", r(r({}, Ia(a.dateSpan, o)), {
                        draggedEl: e.subjectEl,
                        jsEvent: e.origEvent,
                        view: s
                    })), l.create) {
        ...
        return e.prototype.buildDragMeta = function (e) {
            return "object" == typeof this.suppliedDragMeta ? gi(this.suppliedDragMeta) : "function" == typeof this.suppliedDragMeta ? gi(this.suppliedDragMeta(e)) : gi((t = function (e, t) {
                var n = hi.dataAttrPrefix, r = (n ? n + "-" : "") + t;
    ...
    var Va = function () {
        ...
        return n(t, e), t.prototype.renderSimpleLayout = function (e, t) {
            var n = this.props, r = this.context, o = [], i = Qi(r.options);
            return e && o.push({
                type: "header",
                key: "header",
                isSticky: i,
                ...
                }, Ar(ta, {liquid: !n.isHeightAuto && !n.forPrint, cols: [], sections: o}))
            }))
            ...
            var i = this.props, a = this.context, s = !i.forPrint && Qi(a.options), l = !i.forPrint && ea(a.options),
                u = [];
            return e && u.push({
                type: "header",
                key: "header",
    ...
    var Ka = bt({week: "narrow"}), Ja = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.handleRootEl = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return Ar(ua, {
                ...
                return Ar("td", r({
                    ...
                    ref: i.innerElRef
                }, i.showWeekNumber && Ar(fa, {date: a, defaultFormat: Ka}, (function (e, t, n, o) {
    ...
    var ts = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.context, n = t.options.eventTimeFormat || Qa,
    ...
    function os(e, t, n, o, i, a, s, l) {
        ...
        return {
            segsByFirstCol: u.map(is), segsByEachCol: u.map((function (t, n) {
                var o = function (e) {
                    for (var t = [], n = 0, r = e; n < r.length; n++) {
                        var o = r[n];
                        t.push(o.seg)
    ...
    var ss = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            var e = this, t = this.props, n = this.state, r = this.context, o = t.cells.length,
                i = qa(t.businessHourSegs, o), a = qa(t.bgEventSegs, o), s = qa(this.getHighlightSegs(), o),
            ...
            return Ar("tr", {ref: this.rootElRef}, t.renderIntro && t.renderIntro(), t.cells.map((function (n, r) {
                ...
                return Ar(Ja, {
                    ...
                    fgContent: Ar(Wr, null, Ar(Wr, null, o), Ar(Wr, null, u)),
                    bgContent: Ar(Wr, null, e.renderFillSegs(s[r], "highlight"), e.renderFillSegs(i[r], "non-business"), e.renderFillSegs(a[r], "bg-event"))
                })
            })))
        }, t.prototype.componentDidMount = function () {
            this.updateSizing(!0)
            ...
            if (a) for (var l = 0, u = e; l < u.length; l++) {
                ...
                s.push(Ar("div", {
                    ...
                    style: d
                }, "bg-event" === t ? Ar(da, r({seg: c}, bn(c, i))) : ca(t)))
            }
    ...
    var ls = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return Ar(ua, {date: i, dateProfile: l, todayRange: s, elRef: this.handlePopoverEl}, (function (e, t, n) {
                return Ar(ls, {
                    elRef: e,
                    title: c,
                ...
                }, Ar(sa, {date: i, dateProfile: l, todayRange: s}, (function (e, t) {
            ...
            return e < n && t < r ? {
                component: this,
                dateSpan: {allDay: !0, range: {start: o, end: me(o, 1)}},
        ...
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.splitBusinessHourSegs = st(Ga), t.splitBgEventSegs = st(Ga), t.splitFgEventSegs = st(Ga), t.splitDateSelectionSegs = st(Ga), t.splitEventDrag = st(Ya), t.splitEventResize = st(Ya), t.buildBuildMoreLinkText = st(ds), t.rowRefs = new zi, t.state = {morePopoverState: null}, t.handleRootEl = function (e) {
                t.rootEl = e, Kr(t.props.elRef, e)
            }, t.handleMoreLinkClick = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return v && !i && (v = !1, r = null, o = null), Ar("div", {
                ...
                }, t.colGroupNode, Ar("tbody", null, t.cells.map((function (i, a) {
                    return Ar(ss, {
                ...
                })))), !t.forPrint && a && a.currentFgEventSegs === t.fgEventSegs && Ar(us, {
                    date: a.date,
                    dateProfile: n,
                    segs: a.allSegs,
                    alignmentEl: a.dayEl,
    ...
    var fs = function (e) {
        ...
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.slicer = new fs, t.tableRef = Lr(), t.handleRootEl = function (e) {
        ...
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.buildDayTableModel = st(gs), t.headerRef = Lr(), t.tableRef = Lr(), t
        }

        return n(t, e), t.prototype.render = function () {
            var e = this, t = this.context, n = t.options, r = t.dateProfileGenerator, o = this.props,
                i = this.buildDayTableModel(o.dateProfile, r), a = n.dayHeaders && Ar(Ni, {
                    ref: this.headerRef,
    ...
    var ms = lo({
        ...
        views: {
            dayGrid: {
                component: vs, dateProfileGeneratorClass: function (e) {
                    function t() {
                        return null !== e && e.apply(this, arguments) || this
                    }
    ...
    }(hr), Es = bt({hour: "numeric", minute: "2-digit", omitZeroMinute: !0, meridiem: "short"});
    ...
    var bs = function (e) {
    ...
    }(Yr), Cs = bt({week: "short"}), ws = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.allDaySplitter = new ys, t.headerElRef = Lr(), t.rootElRef = Lr(), t.scrollerElRef = Lr(), t.state = {slatCoords: null}, t.handleScrollTopRequest = function (e) {
                ...
                void 0 === e && (e = "");
                var n = t.context.options, o = t.props.dateProfile.renderRange, i = Se(o.start, o.end),
                    a = n.navLinks && 1 === i ? {"data-navlink": yr(o.start, "week"), tabIndex: 0} : {};
                return n.weekNumbers ? Ar(fa, {date: o.start, defaultFormat: Cs}, (function (t, n, o, i) {
                    return Ar("th", {
                        ref: t,
        ...
        return n(t, e), t.prototype.renderSimpleLayout = function (e, t, n) {
            var r = this.context, o = this.props, i = [], a = Qi(r.options);
            return e && i.push({
                type: "header",
                key: "header",
                isSticky: a,
                ...
                return Ar("div", {
                    ...
                    ref: e
                }, Ar(ta, {liquid: !o.isHeightAuto && !o.forPrint, cols: [{width: "shrink"}], sections: i}))
            }))
            ...
            var u = this.context, c = this.props, d = !c.forPrint && Qi(u.options), p = !c.forPrint && ea(u.options),
                f = [];
            e && f.push({
                type: "header",
                key: "header",
                ...
                chunks: [{
                    key: "axis", rowContent: function (e) {
                        return Ar("tr", null, s.renderHeadAxis(e.rowSyncHeights[0]))
                    }
            ...
            return f.push({
                ...
                chunks: [{
                    key: "axis", content: function (e) {
                        return Ar("div", {className: "fc-timegrid-axis-chunk"}, Ar("table", {style: {height: e.expandRows ? e.clientHeight : ""}}, e.tableColGroupNode, Ar("tbody", null, Ar(bs, {slatMetas: i}))), Ar("div", {className: "fc-timegrid-now-indicator-container"}, Ar(Ii, {unit: h ? "minute" : "day"}, (function (e) {
                            var t = h && a && a.safeComputeTop(e);
                            return "number" == typeof t ? Ar(ia, {isAxis: !0, date: e}, (function (e, n, r, o) {
                                return Ar("div", {
                                    ref: e,
                ...
                type: "footer",
                isSticky: !0,
                chunks: [{key: "axis", content: $i}, {key: "cols", content: $i}]
    ...
    var Ts = function () {
        ...
        return e.prototype.safeComputeTop = function (e) {
            ...
            var t, n, r = this.positions, o = this.dateProfile, i = this.slatMetas, a = r.els.length,
                s = i[1].date.valueOf() - i[0].date.valueOf(), l = (e.milliseconds - et(o.slotMinTime)) / s;
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return Ar("tbody", null, e.slatMetas.map((function (i, a) {
                ...
                return Ar("tr", {key: i.key, ref: o.createRef(i.key)}, e.axis && Ar(Ss, r({}, i)), Ar(fo, {
                    hookProps: s,
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            }, e.tableColGroupNode, Ar(ks, {slatElRefs: this.slatElRefs, axis: e.axis, slatMetas: e.slatMetas})))
        }, t.prototype.componentDidMount = function () {
            this.updateSizing()
        }, t.prototype.componentDidUpdate = function () {
            this.updateSizing()
            ...
            var e, t = this.props;
            t.onCoords && null !== t.clientWidth && (this.rootElRef.current.offsetHeight && t.onCoords(new Ts(new _r(this.rootElRef.current, (e = this.slatElRefs.currentMap, t.slatMetas.map((function (t) {
                return e[t.key]
    ...
    function Is(e, t, n, r, o) {
        return Ps(e, t, n, r), function (e, t) {
            for (var n = 0, r = e; n < r.length; n++) {
            ...
            if (function (e) {
                var t, n, r, o, i;
                for (t = 0; t < e.length; t += 1) for (n = e[t], r = 0; r < n.length; r += 1) for ((o = n[r]).forwardSegs = [], i = t + 1; i < e.length; i += 1) Ns(o, e[i], o.forwardSegs)
            }(i), o = i[0]) {
    ...
    var Us = bt({hour: "numeric", minute: "2-digit", meridiem: !1}), Ls = function (e) {
        function t() {
            return null !== e && e.apply(this, arguments) || this
        }
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return this.props.isCondensed && e.push("fc-timegrid-event-condensed"), Ar(ra, r({}, this.props, {
    ...
    var Vs = function (e) {
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return Ar(ua, {
                ...
                }, l, t.extraDataAttrs), Ar("div", {className: "fc-timegrid-col-frame"}, Ar("div", {className: "fc-timegrid-col-bg"}, e.renderFillSegs(t.businessHourSegs, "non-business"), e.renderFillSegs(t.bgEventSegs, "bg-event"), e.renderFillSegs(t.dateSelectionSegs, "highlight")), Ar("div", {className: "fc-timegrid-col-events"}, e.renderFgSegs(t.fgEventSegs, i)), Ar("div", {className: "fc-timegrid-col-events"}, e.renderFgSegs(o, {}, Boolean(t.eventDrag), Boolean(t.eventResize), Boolean(n))), Ar("div", {className: "fc-timegrid-now-indicator-container"}, e.renderNowIndicator(t.nowIndicatorSegs)), Ar(Ws, {
                    date: t.date,
                    dateProfile: t.dateProfile,
                    todayRange: t.todayRange,
                    extraHookProps: t.extraHookProps
            ...
            return (e = Is(e, l.date, l.slatCoords, s.options.eventMinHeight, s.options.eventOrder)).map((function (e) {
                ...
                return Ar("div", {
                    ...
                    isCondensed: e.bottom - e.top < hi.timeGridEventCondensedHeight
            ...
            var a = e.map((function (e) {
                ...
                }, "bg-event" === t ? Ar(da, r({seg: e}, bn(e, i.todayRange, i.nowDate))) : ca(t))
            }));
            return Ar(Wr, null, a)
        }, t.prototype.renderNowIndicator = function (e) {
            var t = this.props, n = t.slatCoords, r = t.date;
            return n ? e.map((function (e, t) {
                return Ar(ia, {isAxis: !1, date: r, key: t}, (function (t, o, i, a) {
                    return Ar("div", {
                        ref: t,
        ...
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.splitFgEventSegs = st(xs), t.splitBgEventSegs = st(xs), t.splitBusinessHourSegs = st(xs), t.splitNowIndicatorSegs = st(xs), t.splitDateSelectionSegs = st(xs), t.splitEventDrag = st(_s), t.splitEventResize = st(_s), t.rootElRef = Lr(), t.cellElRefs = new zi, t
        }
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            }, t.tableColGroupNode, Ar("tbody", null, Ar("tr", null, t.axis && Ar("td", {className: "fc-timegrid-col fc-timegrid-axis"}, Ar("div", {className: "fc-timegrid-col-frame"}, Ar("div", {className: "fc-timegrid-now-indicator-container"}, "number" == typeof n && Ar(ia, {
                isAxis: !0,
                date: t.nowDate
            }, (function (e, t, r, o) {
                return Ar("div", {
    ...
    var js = function (e) {
        ...
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.buildDayRanges = st(qs), t.slicer = new js, t.timeColsRef = Lr(), t.handleRootEl = function (e) {
                e ? t.context.registerInteractiveComponent(t, {el: e}) : t.context.unregisterInteractiveComponent(t)
            }, t
        }
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return Ar(Ii, {unit: a ? "minute" : "day"}, (function (l, u) {
                return Ar(Fs, r({
                    ref: e.timeColsRef,
    ...
    function Zs(e, t, n, r, o) {
        for (var i = new Date(0), a = e, s = Xe(0), l = n || function (e) {
            var t, n, r;
            for (t = Ys.length - 1; t >= 0; t -= 1) if (n = Xe(Ys[t]), null !== (r = tt(n, e)) && r > 1) return n;
            return e
        }(r), u = []; et(a) < et(t);) {
    ...
    var Xs = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.buildTimeColsModel = st(Ks), t.buildSlatMetas = st(Zs), t
        }
    ...
    var el = bt({hour: "numeric", minute: "2-digit", meridiem: "short"}), tl = function (e) {
        function t() {
            return null !== e && e.apply(this, arguments) || this
        }

        return n(t, e), t.prototype.render = function () {
            var e = this.props, t = this.context, n = e.seg, r = t.options.eventTimeFormat || el;
            return Ar(na, {
                seg: n,
                timeText: "",
                disableDragging: !0,
    ...
    var ol = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.computeDateVars = st(al), t.eventStoreToSegs = st(t._eventStoreToSegs), t.setRootEl = function (e) {
                e ? t.context.registerInteractiveComponent(t, {el: e}) : t.context.unregisterInteractiveComponent(t)
            }, t
        }
        ...
        return n(t, e), t.prototype.render = function () {
            ...
            return Ar(Do, {viewSpec: n.viewSpec, elRef: this.setRootEl}, (function (n, o) {
                return Ar("div", {ref: n, className: r.concat(o).join(" ")}, Ar(Vi, {
    ...
    }, ul.prototype.baseIconClass = "fa", ul.prototype.iconClasses = {
        close: "fa-times",
    ...
    }, ul.prototype.iconOverrideOption = "bootstrapFontAwesome", ul.prototype.iconOverrideCustomButtonOption = "bootstrapFontAwesome", ul.prototype.iconOverridePrefix = "fa-";
    ...
    return Go.push(Ba, ms, Js, ll, cl, dl), e.BASE_OPTION_DEFAULTS = wt, e.BASE_OPTION_REFINERS = Ct, e.BaseComponent = Yr, e.BgEvent = da, e.BootstrapTheme = ul, e.Calendar = va, e.CalendarApi = Fn, e.CalendarContent = bi, e.CalendarDataManager = Jo, e.CalendarDataProvider = si, e.CalendarRoot = Ri, e.Component = Or, e.ContentHook = vo, e.CustomContentRenderContext = ho, e.DateComponent = so, e.DateEnv = Jn, e.DateProfileGenerator = To, e.DayCellContent = sa, e.DayCellRoot = ua, e.DayGridView = vs, e.DayHeader = Ni, e.DaySeriesModel = Oi, e.DayTable = hs, e.DayTableModel = Ai, e.DayTableSlicer = fs, e.DayTimeCols = Gs, e.DayTimeColsSlicer = js, e.DayTimeColsView = Xs, e.DelayedRunner = Zo, e.Draggable = Va, e.ElementDragging = fi, e.ElementScrollController = Pr, e.Emitter = xr, e.EventApi = Bn, e.EventRoot = na, e.EventSourceApi = V, e.FeaturefulElementDragging = ka, e.Fragment = Wr, e.Interaction = ui, e.ListView = ol, e.MountHook = mo, e.NamedTimeZoneImpl = li, e.NowIndicatorRoot = ia, e.NowTimer = Ii, e.PointerDragging = Ea, e.PositionCache = _r, e.RefMap = zi, e.RenderHook = fo, e.ScrollController = Ir, e.ScrollResponder = Br, e.Scroller = Vi, e.SimpleScrollGrid = ta, e.Slicer = Ui, e.Splitter = hr, e.StandardEvent = ra, e.Table = cs, e.TableDateCell = xi, e.TableDowCell = _i, e.TableView = ja, e.Theme = Hr, e.ThirdPartyDraggable = Fa, e.TimeCols = Fs, e.TimeColsSlatsCoords = Ts, e.TimeColsView = ws, e.ViewApi = Un, e.ViewContextType = jr, e.ViewRoot = Do, e.WeekNumberRoot = fa, e.WindowScrollController = Nr, e.addDays = me, e.addDurations = Je, e.addMs = ye, e.addWeeks = ge, e.allowContextMenu = ae, e.allowSelection = oe, e.applyMutationToEventStore = Hn, e.applyStyle = q, e.applyStyleProp = Y, e.asCleanDays = function (e) {
        ...
        return et(e) / 1e3
    }, e.buildClassNameNormalizer = yo, e.buildDayRanges = qs, e.buildDayTableModel = gs, e.buildEventApis = Gn, e.buildEventRangeKey = wn, e.buildHashFromArray = function (e, t) {
    ...
    },e.getAllowYScrolling = ji,e.getCanVGrowWithinCell = pr,e.getClippingParents = kr,e.getDateMeta = gr,e.getDayClassNames = mr,e.getDefaultEventEnd = Nn,e.getElSeg = fn,e.getEventClassNames = Cn,e.getIsRtlScrollbarOnLeft = Dr,e.getRectCenter = cr,e.getRelevantEvents = Ot,e.getScrollGridClassNames = Ki,e.getScrollbarWidths = br,e.getSectionClassNames = Ji,e.getSectionHasLiquidHeight = Bi,e.getSegMeta = bn,e.getSlotClassNames = function (e, t) {
    ...
    },e.memoizeObjArg = lt,e.mergeEventStores = Ut,e.multiplyDuration = $e,e.padStart = de,e.parseBusinessHours = ar,e.parseClassNames = Wt,e.parseDragMeta = gi,e.parseEventDef = Jt,e.parseFieldSpecs = se,e.parseMarker = Kn,e.pointInsideRect = sr,e.preventContextMenu = ie,e.preventDefault = Z,e.preventSelection = re,e.rangeContainsMarker = un,e.rangeContainsRange = ln,e.rangesEqual = an,e.rangesIntersect = sn,e.refineEventDef = Xt,e.refineProps = It,e.removeElement = z,e.removeExact = function (e, t) {
        for (var n = 0, r = 0; r < e.length;) e[r] === t ? (e.splice(r, 1), n += 1) : r += 1;
        return n
    },e.render = Ur,e.renderChunkContent = Gi,e.renderFill = ca,e.renderMicroColGroup = Yi,e.renderScrollShim = $i,e.requestJson = Fo,e.sanitizeShrinkWidth = Zi,e.setElSeg = pn,e.setRef = Kr,e.sliceEventStore = cn,e.sliceEvents = function (e, t) {
    ...
    },e.triggerDateSelect = In,e.unmountComponentAtNode = Fr,e.unpromisify = Mr,e.version = "5.3.2",e.whenTransitionDone = $,e.wholeDivideDurations = tt,Object.defineProperty(e, "__esModule", {value: !0}),e
}({});