                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-9">
                                                ...
                                                <input type="text"  name="position_ar" class="form-control" placeholder="Position Ar"/>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-9">
                                                ...
                                                <input type="text"  name="position_en" class="form-control" placeholder="Position En"/>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-9">
                                                <label>Role En</label>
                                                <input type="text"  name="role_en" class="form-control" placeholder="Role En"/>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-9">
                                                <label>Role Ar </label>
                                                <input type="text"  name="role_ar" class="form-control" placeholder="Role En"/>
                                            </div>
