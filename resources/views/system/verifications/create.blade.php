...
@section('content')
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="d-flex flex-column-fluid">
            <div class="container">
                <form id="CreateForm" method="POST" action="{{ route('verifications.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="card card-custom">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="organization_location" class="form-control" required maxlength="255">
                            </div>
                            ...
                            <div class="form-group">
                                <label>Verify Logo 1 (Image)</label>
                                <input type="file" name="verify_logo_1" class="form-control" accept="image/*">
                            </div>

                            <div class="form-group">
                                <label>Verify Logo 2 (Image)</label>
                                <input type="file" name="verify_logo_2" class="form-control" accept="image/*">
                            </div>
    ...
    <script>
        $(document).ready(function () {
            $('#CreateForm').submit(function (e) {
                ...
                // Create a new FormData object including all form fields and files
